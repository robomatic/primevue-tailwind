    ...
    button: ({ context }) => ({
        class: [
            ...
            // Color
            {
                ...
                'bg-primary-200 dark:bg-primary-700 text-primary-700 dark:text-primary-100 hover:bg-primary-300 dark:hover:bg-primary-600/80':
                    context.active,
            },
            ...
            'ring-inset',
            {
                'ring-1 ring-surface-400 dark:ring-surface-700 focus:ring-surface-500 dark:focus:ring-surface-500':
                    !context.active,
                'ring-1 ring-primary-500 dark:ring-primary-600 focus:ring-primary-500 dark:focus:ring-primary-500':
                    context.active,
            },
