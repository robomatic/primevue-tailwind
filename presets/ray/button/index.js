...
export default {
    root: ({ props, context, parent }) => ({
        class: [
            ...
            // Link Button
            {
                'text-primary-600 dark:text-primary-400 bg-transparent ring-transparent':
            ...
            {
                'text-primary-500 dark:text-primary-400 ring-primary-400 hover:bg-primary-400/20':
            ...
            {
                'text-secondary-500 ring-secondary-500 hover:bg-secondary-400/20':
            ...
            {
                'text-success-500 ring-success-500 hover:bg-success-400/20':
            ...
            {
                'text-info-500 ring-info-500 hover:bg-info-400/20 ':
            ...
            {
                'text-warning-500 ring-warning-500 hover:bg-warning-400/20':
            ...
            {
                'text-help-500 ring-help-500 hover:bg-help-400/20':
            ...
            {
                'text-danger-500 ring-danger-500 hover:bg-danger-400/20':
            ...
            // Secondary
            {
                'hover:bg-secondary-600 dark:hover:bg-secondary-400':
                    props.severity === 'secondary' && !props.text && !props.outlined && !props.plain,
            },
            {
            ...
            // Help
            {
                'hover:bg-help-600 dark:hover:bg-help-400':
                    props.severity === 'help' && !props.text && !props.outlined && !props.plain,
            },
            ...
            // Disabled
            {
                ...
                'text-surface-400 dark:text-surface-600 ':
                    context.disabled && (props.outlined || props.text || props.link),
