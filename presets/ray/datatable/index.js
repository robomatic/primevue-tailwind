    ...
    column: {
        headercell: ({ context, props }) => ({
            class: [
                ...
                context.sorted
                    ? 'dark:bg-surface-950/70 dark:text-primary-500'
                    : 'dark:bg-surface-900/50 dark:text-white/80', // Dark Mode
                {
        ...
        sorticon: ({ context }) => ({
            class: [
                'ml-2',
                context.sorted ? 'text-primary-600 dark:text-primary-500' : 'text-surface-700 dark:text-white/70',
            ],
        }),
        sortbadge: {
            class: [
    ...
    bodyrow: ({ context }) => ({
        class: [
            ...
            context.stripedRows
                ? context.index % 2 === 0
                    ? 'bg-surface-0 text-surface-600 dark:bg-surface-900'
                    : 'bg-primary-100/50 text-surface-600 dark:bg-surface-900'
                : '',
            'transition duration-200',
