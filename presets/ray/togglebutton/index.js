    ...
    root: ({ props, context }) => ({
        class: [
            ...
            // Colors
            {
                ...
                'bg-primary-500 dark:bg-primary-500 border-primary-500 dark:border-primary-400 text-white dark:text-surface-900': props.modelValue
            },
            ...
            // States
            {
                ...
                'hover:bg-primary-600 hover:border-primary-600 dark:hover:bg-primary-400 dark:hover:border-primary-300': props.modelValue,
                'outline-none outline-offset-0 ring-2 ring-primary-500/50 dark:ring-primary-500/50': context.focused && !props.disabled
            },
