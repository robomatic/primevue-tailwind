            ...
            class: [
                ...
                'sm:text-sm sm:leading-6',
                {
                    'text-center':
                        ...
                        (parent?.props?.buttonLayout === 'vertical' || parent?.props?.buttonLayout === 'horizontal'),
                    'order-2':
                ...
                // Interactions
                {
                    ...
                    'focus-within:ring-none opacity-60 select-none pointer-events-none cursor-default':
                        context?.disabled,
                },
    ...
    incrementbutton: {
        root: ({ parent }) => ({
            class: [
                ...
                'rounded-md',
                {
                    'rounded-tl-none rounded-br-none rounded-bl-none border-b-0':
    ...
    decrementbutton: {
        root: ({ parent }) => ({
            class: [
                ...
                'rounded-md',
                {
                    'rounded-tr-none rounded-tl-none rounded-bl-none border-t-none':
                        parent.props.showButtons && parent.props.buttonLayout === 'stacked',
                },
                {
