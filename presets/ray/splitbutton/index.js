...
export default {
    root: ({ props }) => ({
        class: [
            ...
            {
                'before:content-[""] before:pointer-events-none before:from-surface-100/20 before:via-black/0 before:to-surface-900/20 before:bg-gradient-to-br before:mix-blend-hard-light before:w-full before:h-full before:absolute before:z-10 before:inset-0':
                    !props.link && !props.disabled && !props.text && !props.outlined && !props.plain,
            },
        ],
    }),
    button: {
        root: ({ parent }) => ({
            class: [
                ...
                // Shape
                {
                    'shadow-sm': !parent.props.raised && !parent.props.link && !parent.props.text,
                ...
                {
                    'text-secondary-500 ring-1 ring-secondary-500 hover:bg-secondary-400/20':
                ...
                // Success Text Button
                {
                    'text-success-500 dark:text-success-600':
                        parent.props.text && parent.props.severity === 'success' && !parent.props.plain,
                },
                // Success Outlined Button
                {
                    'text-success-500 ring-1 ring-success-500 hover:bg-success-400/20':
                ...
                // Info Text Button
                {
                    'text-info-500 dark:text-info-600':
                        parent.props.text && parent.props.severity === 'info' && !parent.props.plain,
                },
                // Info Outlined Button
                {
                    'text-info-500 ring-1 ring-info-500 hover:bg-info-400/20 ':
                ...
                {
                    'text-warning-500 ring-1 ring-warning-500 hover:bg-warning-400/20':
                ...
                // Help Text Button
                {
                    'text-help-500 dark:text-help-600':
                        parent.props.text && parent.props.severity === 'help' && !parent.props.plain,
                },
                // Help Outlined Button
                {
                    'text-help-500 ring-1 ring-help-500 hover:bg-help-400/20':
                ...
                // Danger Text Button
                {
                    'text-danger-500 dark:text-danger-600':
                        parent.props.text && parent.props.severity === 'danger' && !parent.props.plain,
                },
                // Danger Outlined Button
                {
                    'text-danger-500 ring-1 ring-danger-500 hover:bg-danger-400/20':
                ...
                // Plain
                {
                    'hover:bg-gray-600 hover:ring-gray-400':
                        parent.props.plain && !parent.props.outlined && !parent.props.text,
                },
                // Text & Outlined Button
                {
                    'hover:bg-surface-400/20 dark:hover:bg-surface-300/10':
                        parent.props.plain && (parent.props.text || parent.props.outlined),
                },

                // Primary
                {
                    'hover:bg-primary-600 dark:hover:bg-primary-400 hover:ring-primary-300 dark:hover:ring-primary-500':
                        !parent.props.link &&
                        parent.props.severity === null &&
                        !parent.props.text &&
                        !parent.props.outlined &&
                ...
                {
                    'focus-visible:outline-secondary-500 dark:focus-visible:outline-secondary-500':
                        parent.props.severity === 'secondary',
                },
                // Text & Outlined Button
                {
                ...
                {
                    'focus-visible:outline-success-500 dark:focus-visible:outline-success-500':
                        parent.props.severity === 'success',
                },
                // Text & Outlined Button
                {
                    'hover:bg-success-400/20':
                        (parent.props.text || parent.props.outlined) &&
                        parent.props.severity === 'success' &&
                        !parent.props.plain,
                },
                ...
                {
                    'focus-visible:outline-warning-500 dark:focus-visible:outline-warning-500':
                        parent.props.severity === 'warning',
                },
                // Text & Outlined Button
                {
                    'hover:bg-warning-400/20':
                        (parent.props.text || parent.props.outlined) &&
                        parent.props.severity === 'warning' &&
                        !parent.props.plain,
                },
                ...
                // Help
                {
                    'hover:bg-help-600 dark:hover:bg-help-300 hover:ring-help-600 dark:hover:ring-help-300':
                        parent.props.severity === 'help' &&
                        !parent.props.text &&
                        !parent.props.outlined &&
                        !parent.props.plain,
                ...
                {
                    'focus-visible:outline-help-500 dark:focus-visible:outline-help-500':
                        parent.props.severity === 'help',
                },
                // Text & Outlined Button
                {
                    'hover:bg-help-400/20':
                        (parent.props.text || parent.props.outlined) &&
                        parent.props.severity === 'help' &&
                        !parent.props.plain,
                },
                ...
                {
                    'focus-visible:outline-danger-500 dark:focus-visible:outline-danger-500':
                        parent.props.severity === 'danger',
                },
                // Text & Outlined Button
                {
                    'hover:bg-danger-400/20':
                        (parent.props.text || parent.props.outlined) &&
                        parent.props.severity === 'danger' &&
                        !parent.props.plain,
                },
                ...
                // Disabled
                {
                    'bg-surface-300 dark:bg-surface-700 dark:text-surface-800 ring-surface-300 dark:ring-surface-700':
